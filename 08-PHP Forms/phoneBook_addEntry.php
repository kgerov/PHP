			...
			<main>
				<div>
					<form enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
						...
						<div><input type="submit" value="Add Entry" name="Submit1"></div>
					</form>
				</div>
			</main>
		</div>
...
<?php 
	...
	if (isset($_POST['Submit1'])) {
		...
		$user = new User($_POST['firstname'], $_POST['lastname'], $_POST['city'], $_POST['phone'], $_POST['email'], $gen, $_POST['notes'], "lqlqlq", date('Y/m/d H:i:s'), $myfile, $fileSize, $fileType, $path);
		...
		if ($legit) {
			...
			$sql="INSERT INTO book (firstname, lastname, city, phone, email, gender, notes, img, date, name, size, type, file_path)
			VALUES ('$firstname', '$lastname', '$city', '$phone', '$email', '$gender', '$notes', '$data', '$time', '$name', '$size', '$type', '$file_path')";
