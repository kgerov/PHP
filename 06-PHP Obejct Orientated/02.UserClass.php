<?php 
	...
	$rabotesht_pich2 = new Workman("Ganka", "janka", "15", "../pictures/gankasexa.jpg", "female", "baba", "Am i shieeeet", "Yes", "gankasexa@abv.bg", array("Trabant1", "Trabant2", "Trabant3"), array("Brake", "Engine"), 160); 
